    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          actions: <Widget>[
            IconButton(
              icon: Icon(Icons.history,color: Color.fromRGBO(38, 38, 38, 1),),
              onPressed: ()async{
          ...
          title: Text('  Calculator',style: TextStyle(fontFamily: 'Montserrat',
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                expression,
                style: expression.length<10?KCalculationTextStyle:KCalculationSmallTextStyle,
              ),
              SizedBox(
                height: 30,
              ),
